  ...
  return (
    <View style={styles.wrapper}>
      ...
      <View style={styles.bottomNav}>
        ...
        <NavItem icon="👤" label="Profile" active onPress={() => {}} />
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  email: { color: "#DCE9FF", marginTop: 6, fontSize: 14, fontWeight: "700" },
  badge: {
  ...
  badgeText: { color: "#071A2F", fontSize: 13, fontWeight: "900" },
  sectionTitle: {
    color: "#071A2F",
    fontSize: 21,
    fontWeight: "900",
  ...
  menuTextBox: { flex: 1 },
  menuTitle: { color: "#071A2F", fontSize: 17, fontWeight: "900" },
  menuSub: { color: "#667085", fontSize: 13, marginTop: 4, fontWeight: "600" },
  menuArrow: { color: "#1457D9", fontSize: 34, fontWeight: "900" },
  logoutButton: {
  ...
  logoutText: { color: "#E53935", fontSize: 17, fontWeight: "900" },
  footer: {
    color: "#667085",
    textAlign: "center",
    marginBottom: 110,
