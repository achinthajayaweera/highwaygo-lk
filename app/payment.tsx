...
const styles = StyleSheet.create({
  ...
  ticketLabel: { color: "#667085", fontSize: 14, fontWeight: "700" },
  ticketValue: { color: "#071A2F", fontSize: 15, fontWeight: "900" },
  cardPreview: {
    height: 190,
    borderRadius: 28,
  ...
  cardSmall: { color: "#FFD447", fontSize: 15, fontWeight: "900" },
  cardNumber: {
    color: "#FFFFFF",
    fontSize: 24,
    fontWeight: "900",
  ...
  cardName: { color: "#FFFFFF", fontSize: 14, fontWeight: "800" },
  cardExpiry: { color: "#FFFFFF", fontSize: 14, fontWeight: "800" },
  formCard: {
    backgroundColor: "#FFFFFF",
    borderRadius: 28,
    padding: 24,
  ...
  label: { color: "#071A2F", fontSize: 15, fontWeight: "800", marginBottom: 8 },
  input: {
    borderWidth: 1.5,
    borderColor: "#D8E2F0",
    borderRadius: 18,
  ...
  payText: { color: "#FFFFFF", fontSize: 17, fontWeight: "900" },
  backText: {
    color: "#1457D9",
    textAlign: "center",
    marginTop: 22,
