...
const styles = StyleSheet.create({
  ...
  check: { color: "#FFFFFF", fontSize: 64, fontWeight: "900" },
  title: {
    color: "#071A2F",
    fontSize: 32,
    fontWeight: "900",
  ...
  ticketTitle: { color: "#071A2F", fontSize: 22, fontWeight: "900" },
  status: {
  ...
  downloadText: { color: "#FFFFFF", fontSize: 17, fontWeight: "900" },
  homeButton: {
    width: "100%",
  ...
  homeText: { color: "#FFD447", fontSize: 17, fontWeight: "900" },
  outlineButton: {
    width: "100%",
    borderWidth: 1.5,
    borderColor: "#1457D9",
  ...
  outlineText: { color: "#1457D9", fontSize: 16, fontWeight: "900" },
});
