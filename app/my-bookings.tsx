...
const styles = StyleSheet.create({
  ...
  title: { color: "#071A2F", fontSize: 32, fontWeight: "900" },
  subtitle: {
    color: "#667085",
    fontSize: 15,
    marginTop: 8,
  ...
  busName: { color: "#071A2F", fontSize: 20, fontWeight: "900" },
  busNumber: { color: "#667085", marginTop: 4, fontWeight: "700" },
  status: {
  ...
  city: { color: "#FFFFFF", fontSize: 18, fontWeight: "900" },
  small: { color: "#CFE0FF", fontSize: 12, marginTop: 4, fontWeight: "700" },
  arrow: { color: "#FFFFFF", fontSize: 30, fontWeight: "900" },
  infoRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    marginBottom: 12,
  },
  label: { color: "#667085", fontSize: 14, fontWeight: "700" },
  value: { color: "#071A2F", fontSize: 15, fontWeight: "900" },
  qrBox: {
  ...
  qrSub: { color: "#667085", marginTop: 8, fontSize: 13, fontWeight: "700" },
  trackButton: {
  ...
  trackText: { color: "#FFD447", fontSize: 16, fontWeight: "900" },
  downloadButton: {
    backgroundColor: "#1457D9",
    padding: 15,
    borderRadius: 18,
  ...
  downloadText: { color: "#FFFFFF", fontSize: 16, fontWeight: "900" },
});
