...
export default function Buses() {
  ...
  const [sortType, setSortType] = useState<"default" | "low" | "high">("default");
  ...
  const filteredBuses = useMemo(() => {
    ...
    if (sortType === "low") result = [...result].sort((a, b) => a.price - b.price);
    if (sortType === "high") result = [...result].sort((a, b) => b.price - a.price);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.filterRow}>
        <FilterChip label="Default" active={sortType === "default"} onPress={() => setSortType("default")} />
        <FilterChip label="Low Price" active={sortType === "low"} onPress={() => setSortType("low")} />
        <FilterChip label="High Price" active={sortType === "high"} onPress={() => setSortType("high")} />
      </View>
...
const styles = StyleSheet.create({
  ...
  back: { fontSize: 42, color: "#071A2F", fontWeight: "900" },
  title: { fontSize: 22, color: "#071A2F", fontWeight: "900" },
  refresh: { fontSize: 26, color: "#1457D9", fontWeight: "900" },
  routeBox: {
  ...
  routeLabel: { color: "#CFE0FF", fontSize: 12, fontWeight: "800" },
  routeValue: { color: "#FFFFFF", fontSize: 18, fontWeight: "900", marginTop: 4 },
  routeArrow: { color: "#FFFFFF", fontSize: 30, fontWeight: "900" },
  tripInfoRow: { flexDirection: "row", gap: 12, marginBottom: 14 },
  tripInfoCard: {
    flex: 1,
  ...
  tripInfoLabel: { color: "#667085", fontSize: 12, fontWeight: "800" },
  tripInfoValue: { color: "#071A2F", fontSize: 14, fontWeight: "900", marginTop: 5 },
  searchBox: {
    backgroundColor: "#FFFFFF",
    borderRadius: 20,
  ...
  searchInput: { flex: 1, fontSize: 15, color: "#071A2F", fontWeight: "700" },
  ...
  activeChip: { backgroundColor: "#1457D9", borderColor: "#1457D9" },
  chipText: { color: "#667085", fontSize: 13, fontWeight: "900" },
  activeChipText: { color: "#FFFFFF" },
  countText: { color: "#071A2F", fontSize: 16, fontWeight: "900", marginBottom: 14 },
  emptyText: { textAlign: "center", marginTop: 40, color: "#667085", fontWeight: "800" },
  card: {
    backgroundColor: "#FFFFFF",
    borderRadius: 24,
    padding: 14,
  ...
  busName: { color: "#071A2F", fontSize: 17, fontWeight: "900", flex: 1 },
  ratingBadge: {
  ...
  ratingText: { color: "#F5A400", fontSize: 12, fontWeight: "900" },
  busType: { color: "#667085", fontSize: 13, marginTop: 6, fontWeight: "700" },
  timeRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  time: { color: "#071A2F", fontSize: 15, fontWeight: "900" },
  place: { color: "#667085", fontSize: 12, marginTop: 3 },
  lineBox: { flex: 1, alignItems: "center", marginHorizontal: 8 },
  duration: { color: "#667085", fontSize: 11, fontWeight: "700", marginBottom: 5 },
  line: { width: "100%", height: 2, backgroundColor: "#D8E2F0" },
  bottomInfo: {
    marginTop: 18,
    flexDirection: "row",
    justifyContent: "space-between",
  ...
  amenityTitle: { color: "#667085", fontSize: 12, fontWeight: "700", marginBottom: 6 },
  amenities: { fontSize: 18 },
  price: { color: "#1457D9", fontSize: 20, fontWeight: "900" },
  selectButton: {
    backgroundColor: "#1457D9",
    padding: 15,
    borderRadius: 16,
  ...
  selectText: { color: "#FFFFFF", fontSize: 16, fontWeight: "900" },
  bottomNav: {
    position: "absolute",
    bottom: 0,
    left: 0,
  ...
  navIcon: { fontSize: 22, opacity: 0.75 },
  navText: { color: "#667085", fontSize: 12, marginTop: 4, fontWeight: "700" },
});
